...
<html lang="en">
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body style="background:#222 url('{{ asset('media/logos/landing_page.png') }}') no-repeat center center;background-size:100% 100%; background-attachment:fixed; "  id="kt_body"  >
		<!--begin::Main-->
		<div class="d-flex flex-column flex-root">
			<!--begin::Content-->
			<div class="col-lg-4 d-flex flex-center flex-row-fluid px-7 pt-lg-0 pb-lg-0 pt-4 pb-6 bg-transparent" style="position: absolute;">
				<!--begin::Wrapper-->
				<div  class="login-content d-flex flex-column pt-lg-0 pt-12 mt-30 bg-transparent pr-5 pl-5" style="border-radius:10px;width:100%;">
					<!--begin::Logo-->
					<div class="login-logo pb-3 text-center">
						
						<h3 class="text-center"><b>PLN EPI</b></h3>
						<h6 class="text-center">DASHBOARD REALISASI VOLUME (REVOL)</h6>
					</div>
					<!--end::Logo-->
					...
					<div class="login-form">
						...
						<form class="form" id="kt_login_singin_form" method="POST" action="{{ route('action-login') }}">
							...
							<div class="pb-lg-0 pb-5">
								...
								<br><h6 class="text-center">PT PLN (PERSERO) UIK TANJUNG JATI B</h6>
